$("document").ready(function(){
	$(".box6-simple-btn").click(function(){
		...
		if (x == "box6-simple-btn1"){
			...
			document.getElementById("box6-simple-btn2").style.borderBottom = "solid black 1px";
			document.getElementById("box6-simple-btn3").style.borderBottom = "solid black 1px";
			...
			document.getElementById("box6-simple-btn1").style.borderBottom = "solid black 1px";
